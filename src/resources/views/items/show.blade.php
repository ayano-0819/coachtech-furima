    ...
    <div class="item-detail">
        <div class="item-detail__inner">
            ...
            <div class="item-detail__content">
                ...
                <section class="item-detail__section">
                    <h2 class="item-detail__heading item-detail__heading--comment">
                        コメント({{ $commentCount }})
                    </h2>
                    ...
                    @foreach($item->comments as $comment)
                        <div class="item-detail__comment">
                            ...
                            <div class="item-detail__comment-user">
                                ...
                                <p class="item-detail__comment-user-name">
                                    {{ $comment->user->name }}
                                </p>
                            </div>

                            <p class="item-detail__comment-text">
                                {{ $comment->content }}
                            </p>
                ...
                <section class="item-detail__section">
                    ...
                    @auth
                        <form action="{{ route('comments.store', ['item_id' => $item->id]) }}" method="POST" class="item-detail__comment-form">
                            ...
                            <button type="submit" class="item-detail__submit-btn">
                                コメントを送信する
                            </button>
                        </form>
                    @else
